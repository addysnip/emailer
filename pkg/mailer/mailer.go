...
func Handle(body string) error {
	...
	err = Send(payload.Recipient, tem.Subject, BuildBody(payload.Recipient, tem.Subject, out))
	if err != nil {
		return err
	}
...
func BuildBody(to string, subject string, body *bytes.Buffer) []byte {
	msg := []byte("To: " + to + "\r\n" +
		"From: AddySnip <no-reply@addysnip.com>\r\n" +
		"Subject: " + subject + "\r\n" +
		"MIME-version: 1.0;\r\n" +
